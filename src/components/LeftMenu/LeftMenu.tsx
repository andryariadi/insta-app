  ...
  return (
    <>
      <div className="flex flex-col gap-6">
        ...
        <div className="bg-n-1/60 dark:bg-n-7 border dark:border-n-1/10 backdrop-blur p-2 rounded-lg shadow-sm text-sm text-gray-500 dark:text-white flex flex-col gap-2">
          <Link href="/" className="flex items-center gap-4 p-2 rounded-lg hover:bg-slate-200 dark:hover:bg-n-8 transition-all duration-300">
            <Image src="/posts.png" alt="Post" width={20} height={20} />
            <span>My Posts</span>
          </Link>
          <hr className="border-t-1 border-gray-100 dark:border-n-1/10 w-36 self-center" />
          <Link href="/" className="flex items-center gap-4 p-2 rounded-lg hover:bg-slate-200 dark:hover:bg-n-8 transition-all duration-300">
